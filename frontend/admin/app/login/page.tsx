...
export default function LoginPage() {
  ...
  // Handle case where useAuth might not have a provider during SSR
  let authUser = null;
  let authLogin: (token: string, user: any) => void = () => {};
  ...
  try {
    ...
    // AuthProvider not available, will be handled client-side
  }
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${API_CONFIG.API_URL}/auth/login`, {
        method: "POST",
